...
export const metadata = {
  title: "Leandro Carranza — Portfolio",
  description:
    "Analista Universitario en Sistemas Informáticos en formación. Desarrollo full-stack, bases de datos y Business Intelligence.",
};
